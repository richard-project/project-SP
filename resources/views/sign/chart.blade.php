...
@section('script')
<script src="{{ URL::asset('plugins/chart-morris/js/raphael.min.js') }}"></script>
<script src="{{ URL::asset('plugins/chart-morris/js/morris.min.js') }}"></script>
<script src="{{ URL::asset('js/pages/chart-morris-custom.js') }}"></script>
@endsection
